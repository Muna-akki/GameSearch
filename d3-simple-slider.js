  ...
  function g(t, e) {
    ...
    function Q(a) {
      ...
      s
        ...
        .on(
          ...
          f(function (t, e) {
            ...
            switch (t.key) {
              ...
              case "ArrowDown":
                w
                  ? Q.value(l(w[Math.max(0, r - 1)]))
                  : Q.value(l(+o[e.index] - a)),
                  t.preventDefault();
                break;
              case "PageDown":
                w
                  ? Q.value(l(w[Math.max(0, r - 2)]))
                  : Q.value(l(+o[e.index] - 2 * a)),
                  t.preventDefault();
                break;
              case "ArrowRight":
              case "ArrowUp":
                w
                  ? Q.value(l(w[Math.min(w.length - 1, r + 1)]))
                  : Q.value(l(+o[e.index] + a)),
                  t.preventDefault();
                break;
              case "PageUp":
                w
                  ? Q.value(l(w[Math.min(w.length - 1, r + 2)]))
                  : Q.value(l(+o[e.index] + 2 * a)),
                  t.preventDefault();
                break;
              case "Home":
        ...
        O &&
          a
            .select(".track-fill")
            .attr(T + "2", 1 === o.length ? e(o[0]) : e(o[1])),
        a.select(".track-overlay").attr(T + "2", e.range()[1] + 8 * L),
        a
          .select(".axis")
          .call(_(e).tickFormat(A).ticks(M).tickValues(y).tickPadding(b)),
    ...
    function G(t, e) {
      (o[0] !== t[0] || (o.length > 1 && o[1] !== t[1])) &&
        ((o = t), e && q.call("onchange", Q, 1 === t.length ? t[0] : t), U());
    }
    function I(t, a) {
      j &&
        ((a = void 0 !== a && a)
          ? (j
            ...
            O &&
              B.transition()
                ...
                .attr(T + "2", 1 === o.length ? e(t[0]) : e(t[1])))
          : (j
              .selectAll(".parameter-value")
              .data(
                t.map(function (t, e) {
            ...
            O &&
              B.attr(
                T + "1",
                1 === o.length ? e.range()[0] - 8 * F : e(t[0])
              ).attr(T + "2", 1 === o.length ? e(t[0]) : e(t[1]))),
        v &&
          H.text(function (e, a) {
            return D(t[a]);
    ...
    return (
      e &&
        ...
        1 === t || 3 === t
          ? (g = n.max(e.range()) - n.min(e.range()))
          : (p = n.max(e.range()) - n.min(e.range())),
        (e = e.clamp(!0))),
      (Q.min = function (t) {
      ...
      (Q.width = function (t) {
        return arguments.length
          ? ((g = t), e && e.range([e.range()[0], e.range()[0] + g]), Q)
          : g;
      }),
      (Q.height = function (t) {
        return arguments.length
          ? ((p = t), e && e.range([e.range()[0], e.range()[0] + p]), Q)
          : p;
      }),
